    ...
    <View style={[a.gap_md]}>
      <View style={[a.align_start]}>
        <Text style={[{ fontSize: 17, fontWeight: 400, lineHeight: 21 }]}>
          <Trans>
            Let us know your interests. We’ll use this to help customize your feeds.
          </Trans>
        </Text>
      </View>
      <InterestsCard image={require('../../../assets/images/interests/book.png')} />
    </View>
    <View style={[a.border_t, a.mt_lg, { borderColor: '#D8D8D8', borderWidth: 1 }]} />
